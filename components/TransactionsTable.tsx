        ...
        {transactions.map((t: Transaction) => {
          ...
          return (
            ...
            >
              ...
              <TableCell className="pl-2 pr-10 capitalize min-w-24 max-md:hidden">{t.paymentChannel}</TableCell>

              <TableCell className="pl-2 pr-10"><CategoryBadge category={t.category} /></TableCell>
            </TableRow>
          );
        })}
      </TableBody>
